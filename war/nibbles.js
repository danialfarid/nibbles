function init() {
	if (localStorage && localStorage.conf) {
		split = localStorage.conf.split('`');
		if (split.length == 10) {
			document.getElementById('n').value = split[0];  
			document.getElementById('names').value = split[1];  
			document.getElementById('colors').value = split[2];  
			document.getElementById('speed').value = split[3];  
			document.getElementById('lives').value = split[4];  
			document.getElementById('sizex').value = split[5];  
			document.getElementById('sizey').value = split[6];  
			document.getElementById('pixx').value = split[7];  
			document.getElementById('pixy').value = split[8];  
			document.getElementById('playgroundColors').value = split[9];
		} else {
	...
	document.onkeyup = function(e) {
		...
		case  13:
			if (playground == null || (playground != null && playground.interval == null)) {
				if (playground != null && !playground.gameOver) {
